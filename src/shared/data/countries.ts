// ISO 3166-1 alpha-2 country codes paired with E.164 dial codes.
// Source: ITU-T E.164 numbering plan. Some dial codes are shared
// (e.g., US/CA both +1, BS/BB/BM both +1 with NANP area codes).
// Used by the phone country picker in onboarding + settings.

export type Country = {
  code: string; // ISO 3166-1 alpha-2 (e.g., "US")
  name: string; // English display name
  dial: string; // E.164 prefix including + (e.g., "+1")
};
