...
export function AmbientBg() {
  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      <motion.div
        className="absolute h-[40vw] w-[40vw] rounded-full opacity-[0.12] blur-[120px]"
        style={{ background: "var(--accent)", top: "5%", left: "10%" }}
        animate={drift({ x: [0, 60, -30, 0], y: [0, -40, 30, 0] }, 22)}
      />
      <motion.div
        className="absolute h-[35vw] w-[35vw] rounded-full opacity-[0.10] blur-[120px]"
        style={{ background: "var(--success)", top: "50%", left: "60%" }}
        animate={drift({ x: [0, -50, 40, 0], y: [0, 40, -30, 0] }, 26)}
      />
      <motion.div
        className="absolute h-[30vw] w-[30vw] rounded-full opacity-[0.08] blur-[120px]"
